package com.app.hotel.guestservice.api;
...
import com.app.hotel.guestservice.data.Guest;
import com.app.hotel.guestservice.data.GuestRepository;
import com.app.hotel.guestservice.error.BadReqeustException;
import com.app.hotel.guestservice.error.NotFoundException;
...
public class GuestController {
    ...
    public Guest getGuest(@PathVariable("id") Long id) {
    	logger.info("within guest-service GuestController id:"+id);
